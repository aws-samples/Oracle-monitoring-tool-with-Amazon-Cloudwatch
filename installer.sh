...
aws cloudwatch put-dashboard --dashboard-name $dash --dashboard-body file://dash.json --region us-east-1 
sleep 5

echo "Installation Successful. Please login to AWS Console and check the dashboard. The metrics might take few minutes to populate in CloudWatch"